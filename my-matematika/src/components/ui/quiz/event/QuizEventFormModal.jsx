            ...
            <DialogContent className="sm:max-w-lg bg-white text-gray-800 shadow-2xl border border-gray-200 rounded-2xl p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-2">
                    ...
                    <DialogFooter className="mt-6">
                        ...
                        type="submit"
                        disabled={loading}
                        // className=" bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md transition"
                        className="w-full py-2 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200"
                        >
