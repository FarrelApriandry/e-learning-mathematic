// src/components/quiz/QuizDetailModal.jsx
...
export default function QuizMateriDetailModal({ isOpen, onClose, quiz }) {
    if (!quiz) return null;
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    <p className="text-slate-500">Jenis Materi</p>
                                    <p className="font-medium text-slate-800">
                                        {quiz.materi || "-"}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <Badge
                                        className={`${statusColor} text-xs font-medium px-3 py-1 rounded-md`}
                                    >
                                        {quiz.status === "published" ? "Publik" : "Draft"}
                                    </Badge>
                                </div>
