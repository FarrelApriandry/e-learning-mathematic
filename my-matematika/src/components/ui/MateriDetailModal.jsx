// src/components/ui/MateriDetailModal.jsx
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="p-5 sm:p-8 space-y-5 sm:space-y-6 text-[14px] sm:text-[15px] text-slate-700">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <DetailBox
                                    ...
                                    value={
                                        materi.created_at
                                            ? new Date(materi.created_at.seconds * 1000).toLocaleString("id-ID")
                                            : "-"
                                    }
                                />
                                <DetailBox
                                    ...
                                    value={
                                        materi.updated_at
                                            ? new Date(materi.updated_at.seconds * 1000).toLocaleString("id-ID")
                                            : "-"
                                    }
                                />
                            </div>
                                ...
                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                    {materi.youtube_link && (
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 text-blue-600 bg-blue-50 hover:bg-blue-100 transition-all rounded-lg px-3 py-2 text-xs sm:text-sm font-medium border border-blue-100"
                                        >
                                    ...
                                    {materi.pdf_link && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center gap-2 text-indigo-600 bg-indigo-50 hover:bg-indigo-100 transition-all rounded-lg px-3 py-2 text-xs sm:text-sm font-medium border border-indigo-100"
                                        >
                                            <FileText size={16} /> Buka PDF
                                        </a>
                                    )}
                                    {!materi.youtube_link && !materi.pdf_link && (
                        ...
                        {/* FOOTER */}
                        <div className="flex flex-col sm:flex-row justify-between px-5 sm:px-8 py-4 sm:py-5 bg-slate-100 border-t gap-3 sm:gap-0">
                            <Button
                                variant="outline"
                                onClick={onClose}
                                className="w-full sm:w-auto border-2 hover:bg-yellow-500 bg-yellow-400"
                            >
                                Edit
                            </Button>
                            <Button
                                variant="outline"
                                onClick={onClose}
                                className="w-full sm:w-auto hover:bg-slate-200"
                            >
                                Tutup
                            </Button>
                        </div>
