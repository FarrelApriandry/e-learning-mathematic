...
export default function MateriTableFull() {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md border border-slate-100 animate-fadeIn">
            {/* Header */}
            <div className="flex flex-col sm:flex-row items-center justify-between mb-6">
                ...
                <div class=" gap-6 flex flex-row items-center">
                    <div className="relative mt-3 sm:mt-0">
                        ...
                        <input
                            ...
                            className="pl-8 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none text-sm w-full"
                        />
                    </div>
                    <button
                        onClick={() => setOpenAddModal(true)}
                        className="mt-4 sm:mt-0 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl font-medium shadow-sm transition-all"
                    >
                        + Tambah Materi
                    </button>
                </div>
                    ...
                    filteredMateri.map((materi) => (
                        ...
                        <td className="px-4 py-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">#{materi.id.slice(0, 6)}</p>
                            </div>
                            </div>
                        </td>
                        ...
                        <td className="px-4 py-3 text-center">
                            <button
                            className="inline-flex items-center gap-1 bg-slate-900 hover:bg-slate-800 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all"
                            >
                            <Eye size={16} />
                            View
                            </button>
